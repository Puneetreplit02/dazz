...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <Hero
        headline="Leading Education Consultancy in Siliguri & North Bengal"
      ...
      <section className="py-16 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Students from Siliguri Choose Us</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Serving students from Siliguri, Bagdogra, Jalpaiguri, Darjeeling, and across North Bengal for over a decade
            </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            <StatCard icon={Award} value="10+" label="Years of Excellence" index={0} />
