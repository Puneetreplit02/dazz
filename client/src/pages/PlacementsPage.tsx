      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Over the years, Dazzling Academy has successfully placed students from Siliguri, Bagdogra, Jalpaiguri, and North Bengal in top universities and global organizations.
          </p>
        </motion.div>
